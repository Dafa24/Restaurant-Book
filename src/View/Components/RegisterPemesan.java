...
public class RegisterPemesan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Belum punya akun? AYOO Buat akun anda Sekarang");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegisterPemesan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegisterPemesan().setVisible(true);
            }
        });
    }
